...
if __name__ == "__main__":
    ...
    config2 = Config(model='SRGNN', dataset='mydata', config_file_list=['SRGNN.yaml'])
    dataset2 = create_dataset(config2)
    train_data2, valid_data2, test_data2 = data_preparation(config2, dataset2)
    ...
    test_score, test_result = trainer.fit(
        train_data, test_data2, saved=True, show_progress=config["show_progress"]
    )
